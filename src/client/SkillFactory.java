...
public class SkillFactory {
    ...
    public static final ISkill getSkill(final int id) {
        ...
        System.out.println("ZeroMS服务端----------[加载职业技能系统]成功!");
                    ...
                    if (data.getName().equals("skill")) {
                        for (MapleData data2 : data) { // Loop thru each jobs
                            if (data2 != null) {
                                ...
                                List<Integer> job = skillsByJob.get(skillid / 10_000);
                                if (job == null) {
                                    job = new ArrayList<>();
                                    skillsByJob.put(skillid / 10_000, job);
                                }
                                job.add(skillid);
                                ...
                                if (summon_data != null) {
                                    ...
                                    sse.attackAfter = (short) MapleDataTool.getInt("attackAfter", summon_data, 999_999);
