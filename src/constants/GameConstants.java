...
public class GameConstants {
    ...
    private static final int[] exp = {0, 15, 34, 57, 92, 135, 372, 560, 840, 1242, 1716,
        ...
        31344244, 33061908, 34873700, 36784778, 38800583, 40926854, 43169645, 45535341, 48030677, 50662758,//131等到這48030677
    ...
    public static int[] fishingReward = {  //钓鱼物品
        ...
        4031630, 10, // White Bait (3cm)
        4031637, 8, // Sailfish (120cm)
        4031638, 6, // Carp (30cm)
        4031639, 4, // Salmon(150cm)
        4031640, 2, // Shovel
        4031628, 3, // Whitebait (3.6cm)
        4031641, 3, // Whitebait (5cm)
        4031642, 3, // Whitebait (6.5cm)
        4031643, 3, // Whitebait (10cm)
        4031644, 3, // Carp (53cm)
        //4031638, 5, // Carp (60cm)
        1032004, 5, // Carp (100cm)
        1032005, 5, // Carp (100cm)
        1032006, 5, // Carp (100cm)
        1032007, 5, // Carp (100cm)
        1032008, 5, // Carp (100cm)
        1032009, 5, // Carp (100cm)
        1032012, 5, // Carp (100cm)
        1032017, 5, // Carp (100cm)
        1032018, 5, // Carp (100cm)
        1032019, 5, // Carp (100cm)
        1032022, 5, // Carp (100cm)
        1032023, 5, // Carp (100cm)
        1032025, 5, // Carp (100cm)
        1032026, 5, // Carp (100cm)
        1002019, 5, // Carp (100cm)
        1002020, 5, // Carp (100cm)
        1002021, 5, // Carp (100cm)
        1002022, 5, // Carp (100cm)
        1002023, 5, // Carp (100cm)
        1002024, 5, // Carp (100cm)
        1002030, 5, // Carp (100cm)           
        1002033, 5, // Carp (100cm)
        1002039, 5, // Carp (100cm)
        1002040, 5, // Carp (100cm)
        1002085, 5, // Carp (100cm)
        2000002, 5, // Carp (100cm)
        2000003, 5, // Carp (113cm)
        2000006, 5, // Sailfish (128cm)
        2120000, 5, // Sailfish (131cm)
        2000002, 5, // Sailfish (140cm)
        2000002, 5, // Sailfish (148cm)
        2022000, 5, // Carp (100cm)
        2022000, 5, // Carp (100cm)
        2022000, 5, // Carp (100cm)
        2022000, 5, // Carp (100cm)
        2022000, 5, // Carp (100cm)
        ...
        2022003, 5, // Carp (100cm)
        2022003, 5, // Carp (100cm)
        2020013, 5, // Carp (100cm)           
        2020013, 5, // Carp (100cm)
        2000005, 5, // Carp (100cm)
        2000005, 5, // Carp (100cm)
        2000005, 5, // Carp (100cm)
        1032004, 5, // Carp (100cm)
        1032005, 5, // Carp (113cm)
        1032006, 5, // Sailfish (128cm)
        1032007, 5, // Sailfish (131cm)
        1032008, 5, // Sailfish (140cm)
        1032009, 5, // Sailfish (148cm)
        1032012, 5, // Salmon (166cm)
