...
public class CashShopOperation {
    ...
    public static void BuyCashItem(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        switch (action) {
            ...
            case 6:
                {
                    ...
                    if (coupon) {
                        ...
                        if (chr.getCSPoints(useNX) >= 4_800 && chr.getInventory(type).getSlotLimit() < 89) {
                            chr.modifyCSPoints(useNX, -4_800, false);
            ...
            case 29:
                {
                    //36 = friendship, 30 = crush //购买挚友戒指 结婚戒指
            ...
            case 0x2A:
                {
                    ...
                    if ((snCS == 50_200_031) && (c.getPlayer().getCSPoints(1) >= 500)) {
                    ...
                    } else if ((snCS == 50_200_032) && (c.getPlayer().getCSPoints(1) >= 1_000)) {
                        c.getPlayer().modifyCSPoints(1, -1_000);
                        c.getPlayer().modifyCSPoints(2, 1_000);
                        c.getSession().write(MaplePacketCreator.serverNotice(1, "兑换抵1000用卷成功"));
                    } else if ((snCS == 50_200_033) && (c.getPlayer().getCSPoints(1) >= 5_000)) {
                        c.getPlayer().modifyCSPoints(1, -5_000);
                        c.getPlayer().modifyCSPoints(2, 5_000);
