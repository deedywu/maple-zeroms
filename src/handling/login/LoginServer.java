...
public class LoginServer {
    ...
    public static final void run_startup_configurations() {
        /*
         * userLimit =
         * Integer.parseInt(ServerProperties.getProperty("net.sf.odinms.login.userlimit"));
         * serverName =
         * ServerProperties.getProperty("net.sf.odinms.login.serverName");
         * eventMessage =
         * ServerProperties.getProperty("net.sf.odinms.login.eventMessage");
         * flag =
         * Byte.parseByte(ServerProperties.getProperty("net.sf.odinms.login.flag"));
         * adminOnly =
         * Boolean.parseBoolean(ServerProperties.getProperty("net.sf.odinms.world.admin",
         * "false")); maxCharacters =
         * Integer.parseInt(ServerProperties.getProperty("net.sf.odinms.login.maxCharacters"));
         */
        userLimit = Integer.parseInt(ServerProperties.getProperty("ZeroMS.UserLimit"));
        ...
        PORT = Integer.parseInt(ServerProperties.getProperty("ZeroMS.LPort"));
        adminOnly = Boolean.parseBoolean(ServerProperties.getProperty("ZeroMS.Admin", "false"));
        maxCharacters = Integer.parseInt(ServerProperties.getProperty("ZeroMS.MaxCharacters"));
        ...
        try {
            ...
            System.out.println("启动登录端口 " + PORT);
        } catch (IOException e) {
